...
// class fast_limo::Looper
    // public
        ...
        void Looper::init(LoopConfig& cfg){
            ...
            this->icp_source_pc = pcl::PointCloud<PointType>::Ptr (std::make_shared<pcl::PointCloud<PointType>>());
            this->icp_target_pc = pcl::PointCloud<PointType>::Ptr (std::make_shared<pcl::PointCloud<PointType>>());
            this->icp_result_pc = pcl::PointCloud<PointType>::Ptr (std::make_shared<pcl::PointCloud<PointType>>());
